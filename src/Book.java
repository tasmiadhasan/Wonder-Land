...
public class Book {
    public void book(){
        ...
        System.out.println();
        System.out.println("                                                     ----------------------------------------------------");
        All_Movies allMovies=new All_Movies();
        allMovies.allmovies();
        System.out.println();
        System.out.print("                                                     Choose your movie no:");
        String movieno=sc.next();
        System.out.println("                                                     To Buy a Ticket Provide you info:");
        ...
        Shows movies=new Shows(movieno,moviename,modate,movietime);
        movies.show();
